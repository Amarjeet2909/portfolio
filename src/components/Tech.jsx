...
<div className="flex justify-center mt-8">
  <div className="bg-gray-200 p-4 rounded-lg flex flex-col sm:flex-row items-center w-full sm:w-11/12 md:w-100 lg:w-100">
    ...
    <div className="text-center sm:text-left">
      <h2 className="text-lg sm:text-xl text-gray-700 font-bold mb-1">Central Institute of Technology Kokrajhar</h2>
      <h2 className="text-lg sm:text-xl text-gray-700 font-bold mb-6">B.Tech in Computer Science & Engineering (2020-2024) CGPA: 8.5</h2>
      <p className="text-sm sm:text-base text-gray-600 mb-1">Ex-Secretary @Coding Club CITK | Member @Robotics Club</p>
